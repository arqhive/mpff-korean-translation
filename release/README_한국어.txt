메트로이드 프라임 페더레이션 포스 (3DS) 한글 패치 v0.2
제작: arqhive

「메트로이드 프라임 페더레이션 포스」(닌텐도 3DS, 일본판) 비공식 한국어 팬 패치입니다.
게임 안 문자열 2,119개를 전부 번역했습니다.
배포 파일은 두 가지입니다. 게임 안 한글은 같으니 둘 중 하나만 고르면 됩니다.

- MPFF_KO_v0.2_LayeredFS.zip (방법 A)
...
1. MPFF_KO_v0.2_LayeredFS.zip 안의 luma 폴더를 SD 카드 루트에 그대로 복사합니다.
   다음과 같이 파일이 놓이면 됩니다.
...
1. MPFF_KO_v0.2_Patcher.zip 을 폴더째 압축 풉니다.
